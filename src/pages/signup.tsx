          ...
          >
            ...
            <div class="flex flex-col gap-3 rounded-md shadow-sm">
              <div>
                ...
                <input
                  class="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring mt-1.5 flex h-10 w-full rounded-md border px-3 py-2 text-sm text-black file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                  autoComplete="name"
                  id="name"
                  name="name"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <input
                  class="mt-1.5 size-4 rounded border-zinc-300 text-zinc-600 focus:ring-zinc-500"
                  id="terms"
                  name="terms"
                  type="checkbox"
                  required={true}
