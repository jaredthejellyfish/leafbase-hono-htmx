...
async function Navigation({ profile }: Props) {
  return (
    <>
      <nav class="fixed left-0 right-0 top-0 z-30 flex h-14 items-center justify-between bg-gray-100 px-6 dark:bg-zinc-900 sm:h-16">
        <div>
          <a
            href="/"
      ...
      <div class="h-14 w-full bg-transparent"></div>
    </>
  );
}
